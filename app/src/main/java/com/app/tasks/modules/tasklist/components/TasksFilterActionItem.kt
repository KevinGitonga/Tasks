...
/**
 * Represents the TasksApp search action item.
 *
...
fun TasksFilterActionItem(
    ...
    TasksAppStandardIconButton(
        ...
        onClick = onClick,
        modifier = Modifier.testTag(tag = "FilterButton"),
    )
}

@Preview(showBackground = true)
@Composable
private fun TasksFilterActionItem_preview() {
